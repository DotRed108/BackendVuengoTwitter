...
from .views import UserViewSet, get_logged_in_user, get_profile, following_list, follower_list, get_random_profile
...
urlpatterns = [
    ...
    path('api/user/get-random-profile/', get_random_profile, name="get-random-profile")
]
